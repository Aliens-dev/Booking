...
class RenterPropertiesUpdateTest extends TestCase
{
    ...
    public function a_renter_can_update_property()
    {
        ...
        $this->assertDatabaseHas('properties', collect($data)->except('type','type_of_place')->toArray());
    ...
    public function a_renter_can_update_property_title()
    {
        ...
        $property->type = PropertyType::find(1)->first()->title;
        $property->type_of_place = TypeOfPlace::find(1)->first()->title;
        $property = $property->toArray();
